...
func (u *AppointmentUsecase) CreateAppointment(userID, psychologistID int64, comment string) (*domain.Appointment, error) {
...
func (u *AppointmentUsecase) GetMyAppointments(userID int64) ([]domain.Appointment, error) {
...
func (u *AppointmentUsecase) GetPsychologists() ([]domain.Psychologist, error) {
	return u.psychologistRepo.GetAll()
}

func (u *AppointmentUsecase) GetPsychologistByID(id int64) (*domain.Psychologist, error) {
...
func (u *AppointmentUsecase) AddVacation(psychologistID int64, dateFrom, dateTo time.Time, reason string) (*domain.PsychologistSchedule, error) {
	_, err := u.psychologistRepo.GetByID(psychologistID)
	if err != nil {
		return nil, errors.New("psychologist not found")
	}
...
func (u *AppointmentUsecase) GetVacations(psychologistID int64) ([]domain.PsychologistSchedule, error) {
