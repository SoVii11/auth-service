...
func (m *MockAppointmentRepository) GetByID(id int64) (*domain.Appointment, error) {
	args := m.Called(id)
	if args.Get(0) == nil {
...
func (m *MockPsychologistRepository) GetByID(id int64) (*domain.Psychologist, error) {
	args := m.Called(id)
	if args.Get(0) == nil {
		return nil, args.Error(1)
	}
...
func (m *MockScheduleRepository) Create(s *domain.PsychologistSchedule) error {
	args := m.Called(s)
	return args.Error(0)
}
